...
static const CGFloat kAlertButtonHeight = 35;
...
static NSString* kAlertOKButtonNormalColor = @"#e4610f";
static NSString* kAlertOKButtonHighlightColor = @"#C07F22";
...
- (void)makeAlertPopupView
{
    ...
    {
        frame = CGRectMake(0, 0, 300, 190);
    }
    
    else
    {
        frame = CGRectMake(0, 0, 240, 195);
    }
